...
class _AnchorTargetLayer_FPN(nn.Module):
    ...
    def forward(self, input):
        ...
        anchors = torch.from_numpy(generate_anchors_all_pyramids(self._fpn_scales, self._anchor_ratios,
                                                                 ...
                                                                 self._fpn_anchor_stride, rpn_rank_inds)).type_as(scores)
        ...
        bbox_outside_weights[labels == 1] = positive_weights * 1.0
        bbox_outside_weights[labels == 0] = negative_weights * 1.0
